---
title: "Demo NeurIPS 2024 template"
author:
...
This template was adapted from [github.com/mikemahoney218/quarto-arxiv](https://github.com/mikemahoney218/quarto-arxiv).
...
![A sunflower](img/sunflower.png){#fig-sunflower}
...
| Markdown Format                           | Output                                                              |
+===========================================+=====================================================================+
|     Blah Blah [see @Knuth_1984_Literate_programming, pp. 33-35; | Blah Blah [see @Knuth_1984_Literate_programming, pp. 33-35; also @Wickham_2015_R_packages, chap. 1]   |
|     also @Wickham_2015_R_packages, chap. 1]           |                                                                     |
+-------------------------------------------+---------------------------------------------------------------------+
|     Blah Blah [@Knuth_1984_Literate_programming, pp. 33-35,     | Blah Blah [@Knuth_1984_Literate_programming, pp. 33-35, 38-39 and passim]                 |
|     38-39 and passim]                     |                                                                     |
+-------------------------------------------+---------------------------------------------------------------------+
|     Blah Blah [@Wickham_2015_R_packages; @Knuth_1984_Literate_programming]. | Blah Blah [@Wickham_2015_R_packages; @Knuth_1984_Literate_programming].                               |
+-------------------------------------------+---------------------------------------------------------------------+
|     Wickham says blah [-@Wickham_2015_R_packages]     | Wickham says blah [-@Wickham_2015_R_packages]                                   |
+-------------------------------------------+---------------------------------------------------------------------+
...
| Markdown Format                   | Output                        |
+===================================+===============================+
|     @Knuth_1984_Literate_programming says blah.         | @Knuth_1984_Literate_programming says blah.         |
+-----------------------------------+-------------------------------+
|     @Knuth_1984_Literate_programming [p. 33] says blah. | @Knuth_1984_Literate_programming [p. 33] says blah. |
+-----------------------------------+-------------------------------+
